...
public class AppSqlHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        StringBuffer useting = new StringBuffer();
        useting.append("CREATE TABLE user_settings(");
        useting.append("id INTEGER PRIMARY KEY AUTOINCREMENT,");
        useting.append("setting_name VARCHAR(32),");
        useting.append("setting_value VARCHAR(128)");
        useting.append(");");
        db.execSQL(useting.toString());
