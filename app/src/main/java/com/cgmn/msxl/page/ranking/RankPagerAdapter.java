...
public class RankPagerAdapter extends FragmentPagerAdapter {
    private static final String[] TAB_TITLES = new String[]{"收益率","连板战法", "趋势波段","可转债"};
    private static final Integer[] types = new Integer[]{StockHolder.RANK_SUMMARY,StockHolder.LEADING_STRATEGY, StockHolder.NORMAL_STRATEGY, StockHolder.KZZ_STRATEGY};
