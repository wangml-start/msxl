...
public class PhotoPop extends PopupWindow {
    ...
    public PhotoPop(Activity context, View.OnClickListener selectListener, View.OnClickListener captureListener) {
        super(context);
    ...
    private void Init() {
        ...
        mView = inflater.inflate(R.layout.pop_header_item, null);
