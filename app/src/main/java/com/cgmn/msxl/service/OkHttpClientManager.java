...
public class OkHttpClientManager{
     ...
     * @return
     */
    private Response _post(String url, File[] files, String[] fileKeys, Param... params)
            throws IOException {
    ...
    private Response _post(String url, File file, String fileKey, Param... params)
            throws IOException {
     ...
     * @throws IOException
     */
    private void _postAsyn(String url, ResultCallback callback,
